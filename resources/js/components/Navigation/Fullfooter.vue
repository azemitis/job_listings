<template>
  <div class="relative pt-8 pb-6">
    <div class="container mx-auto px-4">
      <div class="mt-8 space-x-6 flex flex-row justify-left pb-10">
        <div class="font-semibold text-xl text-align-top text-gray-700">
          Follow Life at Corp on
        </div>
      ...
      <div class="flex flex-wrap text-left lg:text-left">
        <div class="w-full lg:w-6/12">
          <div class="flex flex-wrap items-top mb-6">
            <div class="w-full lg:w-6/12 ml-auto">
              <span class="text-gray-700 mb-5 text-2xl font-semibold"
                >More about us</span
              >
        ...
        <div class="w-full lg:w-6/12 px-4">
          <h4 class="text-2xl font-semibold text-gray-700 mb-8">
            Let's keep in touch!
          </h4>
          <h5 class="mt-0 mb-2 text-gray-700 text-sm">
            Corp is proud to be an equal opportunity workplace and is an
            ...
            consistent with legal requirements. See also Corp's EEO Policy and
